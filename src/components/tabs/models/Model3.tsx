...
export default function Model3() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ══ CARD 1: Eliminazione urinaria ══ */}
      <LockableSection title="3. Eliminazione urinaria">
        <div className="space-y-5">
          ...
          {/* Presidi urinari */}
          <p className={SUB}>Presidi urinari</p>
      ...
      {/* ══ CARD 2: Eliminazione intestinale ══ */}
      <LockableSection title="Eliminazione intestinale">
        <div className="space-y-5">
          ...
          {/* Presidi intestinali */}
          <p className={SUB}>Presidi intestinali</p>
          <div className="space-y-3">
            <div className="rounded-lg border border-slate-200 p-3 space-y-2">
