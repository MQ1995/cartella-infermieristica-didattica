...
export default function Model2() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ══ CARD 1: Alimentazione e nutrizione ══ */}
      <LockableSection title="2. Nutrizione e metabolismo">
        <div className="space-y-5">
          ...
          {/* ── Dentatura, deglutizione e nutrizione artificiale ── */}
      ...
      {/* ══ CARD 2: Cute, tessuti e valutazione rischi ══ */}
      <LockableSection title="Cute, tessuti e valutazione rischi">
        <div className="space-y-5">

          {/* ── Stato dei tessuti e cute ── */}
          ...
          {/* ── Accessi vascolari ── */}
          <p className={SUB}>Accessi vascolari e integrità cutanea</p>

          <div className="rounded-lg border border-slate-200 p-4 space-y-3">
            <div className="flex items-center gap-4">
              <span className="text-sm font-medium text-slate-700">Accessi vascolari</span>
              <label className={RL}><input type="radio" value="false" {...register('vascularAccess')} className={RADIO} /> No</label>
              <label className={RL}><input type="radio" value="true"  {...register('vascularAccess')} className={RADIO} /> Sì</label>
            </div>
            {vascularAccess === 'true' && (
              <div className="space-y-3 pt-2 border-t border-slate-100">
                <div className="flex gap-4">
                  <label className={RL}><input type="radio" value="venoso"    {...register('vascularAccessType')} className={RADIO} /> Venoso</label>
                  <label className={RL}><input type="radio" value="arterioso" {...register('vascularAccessType')} className={RADIO} /> Arterioso</label>
                </div>
          ...
          <div className="rounded-lg border border-slate-200 p-4 space-y-3">
            <div className="flex items-center gap-4">
              ...
              <label className={RL}><input type="radio" value="true"  {...register('skinIntegrity')} className={RADIO} /> Integra</label>
              <label className={RL}><input type="radio" value="false" {...register('skinIntegrity')} className={RADIO} /> Non integra</label>
            </div>
            {skinIntegrity === 'false' && (
              <div className="space-y-3 pt-2 border-t border-slate-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-4 pt-1">
                  <label className={RL}><input type="radio" value="true"  {...register('malnutritionRisk')} className={RADIO} /> Sì</label>
                  <label className={RL}><input type="radio" value="false" {...register('malnutritionRisk')} className={RADIO} /> No</label>
                </div>
              </div>
          ...
          <div className="rounded-lg border border-slate-200 p-4 space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-4">
                ...
                <label className={RL}><input type="radio" value="false" {...register('pressureUlcerRiskFactors')} className={RADIO} /> No</label>
                <label className={RL}><input type="radio" value="true"  {...register('pressureUlcerRiskFactors')} className={RADIO} /> Sì</label>
              </div>
